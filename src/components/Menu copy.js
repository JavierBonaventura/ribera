    ...
    <div className="containerHome pt-8 background">
      ...
      <div className="body">
        <div className="containerHome pt-16">
          ...
          {mostrarMenu1 && (
            <Link to="/history" className="subMenu" style={robotoFontRegular}>
              HISTORY
            </Link>
          )}
          ...
          {mostrarMenu2 && (
            <Link to="/wineyard" className="subMenu" style={robotoFontRegular}>
              THE VINEYARD
            </Link>
          )}
          ...
          {mostrarMenu3 && (
            <Link to="/araucana" className="subMenu" style={robotoFontRegular}>
              ARAUCANA
            </Link>
          )}
          {mostrarMenu3 && (
          ...
          {mostrarMenu3 && (
            <Link to="/clasico" className="subMenu" style={robotoFontRegular}>
              CLÁSICO
            </Link>
          )}
          {mostrarMenu3 && (
            <Link to="/especial" className="subMenu" style={robotoFontRegular}>
              ESPECIAL
            </Link>
          )}
          {mostrarMenu3 && (
