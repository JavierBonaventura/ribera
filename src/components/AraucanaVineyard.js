...
<div>
          ...
          <div className="flex flex-col gap-y-5">
            <div className="w-2/3 mx-auto">
              <p className="text-[#F2ECE1] text-xs leading-6">
                "Río de los Ciervos" es un pequeño pueblo ubicado en tierra del
                fuego. En esta región Patagónica en 300 km se pueden recorrer
                todos los paisajes, desde el mar, hasta el desierto, la montaña
                y los ríos típicos del sur. En ese pueblo nació Don Julio
                Menéndez Prendes Abuelo de Felie. A través de este vino
                intentamos mostrar la diversidad de la zona clásica del valle
                del río negro, la uva proviene de 8 viñedos, ubicados a lo largo
                de los 200k a la vera norte y sur del río."
              </p>
            </div>
    ...
    <div className="bg-[#231F20] py-5 flex flex-col gap-y-10">
      <div
        className="container mx-auto flex flex-col justify-center items-center gap-y-5"
      >
        <div><img src={araucanaMalbec} alt="" /></div>
        <div>
          <h1 className="uppercase text-xs text-[#C3B17D] text-center">
            Araucana Malbec
          </h1>
        ...
        <div className="bg-[#C3B17D] px-5 py-1 rounded-md">
          <a href="" className="uppercase text-xs text-[#F2ECE1]">Read more</a>
        </div>
      </div>
      <div
        className="container mx-auto flex flex-col justify-center items-center gap-y-5"
      >
        <div><img src={araucanaAzul} alt="" /></div>
        <div>
          <h1 className="uppercase text-xs text-[#C3B17D] text-center">
            Araucana Azul
          </h1>
    ...
    <div className="bg-[#231F20] py-20">
      <div className="container mx-auto flex justify-center">
        <div className="border border-[#C3B17D] rounded-full p-7">
          <img src="img/icon-ig.png" alt="" className="w-5" />
        </div>
      </div>
    </div>
    </div>
