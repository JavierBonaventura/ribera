              ...
              <div>
                ...
                <div className="flex flex-col gap-y-5  md:gap-y-14   w-2/4 mx-auto ">
                  ...
                  <div className="space-y-5 md:space-y-14">
                    ...
                    >
                      Araucana Azul is a blend of barrels. We carefully select
                      the barrels that showcase the utmost elegance from our
                      wines in the Southern sector of the vineyard, where the
                      vineyard's highest limestone content yields greater
