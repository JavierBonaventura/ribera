...
const FormularioContacto = () => {
  ...
  // Fin variables paraa manejar el estado del envio del mail
   ...
   // Inicio Configuración del transporte con Ethereal Email
   const transporter = nodemailer.createTransport({
    host: "smtp.ethereal.email",
    port: 587,
    auth: {
      user: 'fleta5@ethereal.email',
      pass: 'rKBFyMp64JXsagq5k2'
    },
  });
   // Fin Configuración del transporte con Ethereal Email
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const mailOptions = {
        from: email,
        to: "destinatario@example.com", // Cambiar al destinatario deseado
        subject: "Contact Form Submission",
        text: `Name: ${nombre} ${apellido}\nEmail: ${email}\nCountry: ${pais}\nMessage: ${consulta}`,
      };
